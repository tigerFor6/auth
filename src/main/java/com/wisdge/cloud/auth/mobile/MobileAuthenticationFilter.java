...
public class MobileAuthenticationFilter extends AbstractAuthenticationProcessingFilter {
    private String mobileParamter = SecurityConstant.SPRING_SECURITY_MOBILE_KEY;
    private String codeParamter = SecurityConstant.SPRING_SECURITY_CODE_KEY;
    private boolean postOnly = true;

    public MobileAuthenticationFilter() {
        super(SecurityConstant.SPRING_SECURITY_MOBILE_TOKEN_URL);
    }
